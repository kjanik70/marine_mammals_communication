...
Tests different generation hyperparameters on known-good prompts.

Usage:
    PYTHONPATH=. python3 scripts/generate_dac_9cb_comparison.py \
...
def main():
    ...
    out_dir = Path(args.output_dir) if args.output_dir else ckpt_path.parent / "comparison"
